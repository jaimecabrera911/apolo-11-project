...
'''
Este archivo es responsable de ejecutar la interfaz de usuario. Aquí, el menú presenta diversas opciones que permiten al 
usuario generar informes de manera sencilla.
